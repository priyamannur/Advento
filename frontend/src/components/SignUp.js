...
if(!emailRegex.test(email)){
   ...
   notifyA("Password must conatain at least 8 characters,at least 1 number and both lower and uppercase letters and special characters for example #, ?, ! ")
   return
}
  ...
  return (
    ...
    <div className='form-container'>
     ...
     <input type='text' name="name" id="name"
        placeholder='Full Name' value={name} onChange={(e)=>
